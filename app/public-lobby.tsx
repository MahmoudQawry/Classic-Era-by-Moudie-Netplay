    ...
    <FlatList
      ...
      ListHeaderComponent={<View>
        <View style={styles.header}>
          ...
          <View style={styles.titleRow}><Image source={require("@/assets/images/classic-era-new-icon.png")} style={styles.brandIcon} /><View><Text style={styles.title}>{t("lbTitle")}</Text><Text style={styles.subtitle}>{t("homeBrandSub")}</Text></View></View>
