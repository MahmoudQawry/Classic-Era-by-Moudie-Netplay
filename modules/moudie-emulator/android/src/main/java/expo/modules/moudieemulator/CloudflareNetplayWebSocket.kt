        ...
        try{
          ...
          if(event=="netplay:quality-pong"){
            ...
            if(sent!=null){
              ...
              onQuality(NetplayQuality(rttMs=measuredRttMs.toLong(),jitterMs=measuredJitterMs.toLong(),probeLossPercent=0,grade="CONNECTED",recommendedDelay=delay.toLong().coerceIn(2L,45L)))
            }
          }
