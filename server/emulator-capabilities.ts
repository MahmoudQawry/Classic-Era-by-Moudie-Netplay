...
export type EmulatorRoomCapability = {
  ...
  netplay: "retroarch" | "psp-network" | "moudie-relay"; maxPlayers: number; maxSpectators: number; note: string;
};
...
export const EMULATOR_ROOM_CAPABILITIES: Record<RoomSystem, EmulatorRoomCapability> = {
  ...
  sega: { system: "sega", coreName: "Genesis Plus GX", maxRoomMembers: roomMemberLimit("sega"), defaultControllerSeats: 2, maxControllerSeats: 4, netplay: "moudie-relay", maxPlayers: ROOM_CAPACITIES.sega.maxPlayers, maxSpectators: ROOM_CAPACITIES.sega.maxSpectators, note: "Up to 4 active players and 4 spectators when the game supports four controllers." },
  n64: { system: "n64", coreName: "Parallel-N64", maxRoomMembers: roomMemberLimit("n64"), defaultControllerSeats: 2, maxControllerSeats: 4, netplay: "moudie-relay", maxPlayers: ROOM_CAPACITIES.n64.maxPlayers, maxSpectators: ROOM_CAPACITIES.n64.maxSpectators, note: "Nintendo 64 uses Moudie deterministic relay/lockstep room sync with up to 4 controller seats." },
  ps2: { system: "ps2", coreName: "Play!", maxRoomMembers: roomMemberLimit("ps2"), defaultControllerSeats: 2, maxControllerSeats: 4, netplay: "moudie-relay", maxPlayers: ROOM_CAPACITIES.ps2.maxPlayers, maxSpectators: ROOM_CAPACITIES.ps2.maxSpectators, note: "Play! is packaged for Android; multiplayer uses Moudie relay/lockstep rather than Play! native netplay." },
};
